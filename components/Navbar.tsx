...
const Navbar = () => {
  return (
    ...
    <nav className=' border-divider-light border-b dark:border-divider-dark'>
      <div className='fixed z-40 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-colors duration-500 lg:z-50  bg-white/70 backdrop-blur  dark:bg-slate-900/80 fm:hidden'>
